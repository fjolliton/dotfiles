...
(let ((bg-color "#1a1a1a")
  ...
  (custom-theme-set-faces 'tuxee
    ...
    '(header-line ((t (:background "#1a1a1a" :foreground "grey70" :box nil :overline nil :underline "#333"))))
    ...
    '(org-date ((t (:foreground "#ade" :underline t))))
    '(org-done ((t (:foreground "#7b5"))))
    '(org-headline-done ((t (:strike-through "#888"))))
