...
(custom-theme-set-faces 'tuxee
  ...
  '(default ((t (:inherit nil :stipple nil :background "#1A1A1A" :foreground "white" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 115 :width normal :foundry "PfEd" :family "Inconsolata"))))
