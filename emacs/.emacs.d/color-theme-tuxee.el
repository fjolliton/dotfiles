...
(let ((bg-color "#1a1a1a")
  ...
  (custom-theme-set-faces 'tuxee
    ...
    '(header-line ((t (:background "#2c2c2c" :foreground "grey70" :box nil :overline nil :underline nil))))
    ...
    '(nano-face-header-faded ((t (:inherit nano-face-header-popout :foreground "#333"))) t)
    '(nano-face-header-popout ((t (:background "#666" :foreground "black"))) t)
